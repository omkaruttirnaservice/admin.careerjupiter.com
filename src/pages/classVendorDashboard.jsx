...
//         <div className="relative h-48 md:h-64 bg-gradient-to-r from-indigo-500 to-purple-500">
//           <img
...
//               <HiAcademicCap className="text-indigo-600 text-4xl" />
//             </div>
...
//           {
//             title: "Category",
//             value: classDetails.category?.join(", ") || "N/A",
//             icon: <FaLayerGroup />,
//           },
//         ].map((item, i) => (
//           <div
//             key={i}
//             className="flex items-start gap-4 bg-white rounded-xl p-4 shadow-md hover:shadow-xl transition-all duration-300"
//           >
//             <div className="text-indigo-600 text-2xl">{item.icon}</div>
//             <div>
//               <h4 className="text-sm font-bold text-gray-700">{item.title}</h4>
//               <p className="text-gray-600 text-sm">{item.value || "N/A"}</p>
//             </div>
//           </div>
//         ))}
//       </div>
...
//       {/* Description */}
//       <div className="max-w-6xl mx-auto bg-white rounded-xl p-6 shadow-md mb-6">
...
//             {classDetails.imageGallery.map((img, idx) => (
//               <div
//                 key={idx}
