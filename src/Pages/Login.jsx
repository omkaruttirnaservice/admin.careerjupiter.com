...
const Login = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (role === 'VENDOR-college') endpoint = `${API_BASE_URL}/api/admin/login-college`;
    ...
    return (
        <div
            // className="relative flex justify-center items-center min-h-screen overflow-hidden bg-gradient-to-br from-purple-700 to-orange-500"
