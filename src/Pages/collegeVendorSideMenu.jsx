...
const getGreeting = () => {
  ...
  if (hour < 12) return { text: "Good Morning", emoji: ":sun_with_face:", color: "#FACC15" };
  if (hour < 16) return { text: "Good Afternoon", emoji: ":sunny:", color: "#FB923C" };
  return { text: "Good Evening", emoji: ":crescent_moon:", color: "#60A5FA" };
};
const navigation = [
  {
    name: "Dashboard",
