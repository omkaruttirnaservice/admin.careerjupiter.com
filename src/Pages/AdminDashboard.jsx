...
import { GiGraduateCap, GiSchoolBag, GiTeacher, GiNotebook, GiNetworkBars } from 'react-icons/gi';
        ...
        <div className="p-6 bg-gradient-to-br from-blue-100 to-blue-50 min-h-screen">
          ...
          <div className="w-full h-64">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-blue-100">
                <h2 className="text-2xl font-extrabold text-blue-800 mb-6">🚀 Quick Shortcuts</h2>
