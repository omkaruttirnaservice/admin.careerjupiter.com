    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                formData.append(
                    'accreditation',
                    accreditationOptions.includes(values.accreditation) ? values.accreditation : ''
                );
                ...
                values.address.forEach((address, idx) => {
                    ...
                    formData.append(`address[${idx}][nearbyLandmarks]`, address.nearbyLandmarks);
                    formData.append(`address[${idx}][autorizedName]`, address.autorizedName);
                    formData.append(`address[${idx}][autorizedPhono]`, address.autorizedPhono);
                  ...
                  {formik.errors.gallery_image}
                    ...
                    {formik.values.address &&
                        ...
                        formik.values.address.some(
                            (addr) =>
                                addr.line1 || addr.line2 || addr.pincode || addr.state || addr.dist
                        ) && (
                    ...
                    <div className="mt-4 flex justify-end gap-4">
                        ...
                        <motion.button
                            ...
                            {formik.isSubmitting || mutation.isPending ? 'Submitting...' : 'Submit'}
                        </motion.button>
                    </div>
                </form>
