...
//     setLocations((prev) => [...prev, newLocation]); // Add new location to the list
...
//         <CurrentLocationButton onGetLocation={addLocation} />
//       </div>

//        {/* List of selected locations with remove option */}
//       {locations.length > 0 && (
//         <div className="mb-4">
//           {locations.map((loc, index) => (
//             <div key={index} className="flex items-center justify-between bg-gray-100 p-2 rounded mb-2">
//               <span>
//                 <strong>Lat:</strong> {loc.lat}, <strong>Lng:</strong> {loc.lan}
//               </span>
//               <button onClick={() => removeLocation(index)} className="text-red-500 hover:text-red-700">
//                 <FaTrash />
//               </button>
//             </div>
//           ))}
...
//       <MapContainer
//         center={[defaultLocation.lat, defaultLocation.lan]}
//         zoom={6}
        ...
        <div className="mb-4">
          {locations.map((loc, index) => (
            <div key={index} className="flex items-center justify-between bg-gray-100 p-3 rounded-lg mb-2 shadow-sm">
              ...
              <button
              type="button" onClick={() => removeLocation(index)} className="bg-red-100 text-red-600 p-2 rounded-full hover:bg-red-200 transition">
                <FaTrash />
              </button>
            </div>
          ))}
