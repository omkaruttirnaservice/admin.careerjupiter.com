...
const ClassForm = ({ onClose }) => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            ownerOrInstituteName: Yup.string().required('Owner/Institute Name is required'),
        ...
        onSubmit: async (values, { setSubmitting, resetForm }) => {
            try {
                ...
                console.log('📌Final FormData Sent:', Object.fromEntries(formData.entries()));

                const response = await axios.post(`${API_BASE_URL}/api/class/create`, formData, {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative bg-[url('https://wallpapers.com/images/hd/virtual-classroom-background-xl1p59ku6y834y02.jpg')] bg-cover bg-center bg-fixed">
            ...
            <AddressModal
                ...
                initialData={
                    editingAddressIndex !== null ? formik.values.address[editingAddressIndex] : null
                }
            />
        </div>
    );
