...
import { FaUserCircle, FaChalkboardTeacher, FaGraduationCap, FaInfoCircle } from 'react-icons/fa';
import {
    FaPhone,
    FaCalendarAlt,
    FaTags,
        ...
        const fetchClassDetails = async () => {
            ...
            try {
                ...
                setClassDetails({
                    ...
                    description: classData?.info?.description || 'No description available', // ✅ Fix Description Extraction
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {[
                            ...
                            },
                            {
                                ...
                                value:
                                    classDetails?.modeOfTeaching?.length > 0
                                        ? classDetails.modeOfTeaching.join(', ')
                                        : 'N/A',
                            ...
                            },
                            {
                                title: 'Category',
                                value:
                                    classDetails?.category?.length > 0
                                        ? classDetails.category.join(', ')
                                        : 'N/A',
