...
import { FaEye, FaGlobe, FaPencilAlt, FaPlus, FaTrashAlt } from 'react-icons/fa';
...
import { deleteUniversity, fetchAllUniversities } from './universityapi';
...
function UniversityList() {
    ...
    const deleteMutation = useMutation({
        ...
        onError: (error) => {
            toast.error(
                `Error deleting university: ${error.message || 'Failed to delete university'}`
            );
        },
    });
        ...
        <div className="bg-white shadow-xl rounded-xl p-6 border border-blue-300">
            <div className="flex justify-between items-center bg-gradient-to-r from-blue-700 to-blue-500 text-white p-3 rounded-t-lg shadow-lg mb-6">
                <h2 className="text-2xl font-bold flex items-center gap-4">
                    <FaGlobe className="text-black bg-white p-2 rounded-md shadow-md" size={30} />
                    University List
                </h2>
                                            ...
                                            <div className="flex items-center gap-1">
                                                ...
                                                {university.entrance_exam_required.length > 1 && (
                                                    <button
                                                        ...
                                                        className="bg-green-300 text-gray-700 px-2 py-1 rounded-full cursor-pointer text-xs hover:bg-gray-300">
                                                        +
                                                        {university.entrance_exam_required.length -
                                                            1}
                                                    </button>
                                                )}
                                            </div>
