...
const ViewUniversityModal = ({ university, isOpen, onClose }) => {
  ...
  // Add this at the top of your ViewUniversityModal.jsx (above the component)
const getImageUrl = (img) => {
  ...
  {console.log("University Image URL:", getImageUrl(university.image))}
  {university.image ? (
    <img
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p>{university.admissionEntranceDetails.lastYearCutoffMarks }</p>
                </div>
