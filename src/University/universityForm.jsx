                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="mb-3">
                        ...
                        <Select
                            ...
                            onChange={(option) => {
                                formik.setFieldValue('address.state', option ? option.value : '');
                            }}
                    ...
                    <div className="mb-3">
                        ...
                        <Select
                            ...
                            onChange={(option) => {
                                formik.setFieldValue('address.dist', option ? option.value : '');
                            }}
                                ...
                                {accreditationOptions.map((option, index) => (
                                    <div key={index} className="flex items-center">
                                        <input
                                            ...
                                            checked={
                                                formik.values.accreditation?.includes(option) ||
                                                false
                                            }
                                            onChange={(e) => {
                                                const currentValues =
                                                    formik.values.accreditation || [];
                                                const newValues = e.target.checked
                                ...
                                {facilities.map((facility, index) => (
                                    <div key={index} className="flex items-center">
                                        <input
                                            ...
                                            checked={
                                                formik.values.facilities?.includes(facility) ||
                                                false
                                            }
                                            onChange={(e) => {
                                                const currentValues =
                                ...
                                {entranceExams.map((exam, index) => (
                                    <div key={index} className="flex items-center">
                                        <input
                                            ...
                                            id={`exam-${exam}`}
                                            checked={
                                                formik.values.entrance_exam_required?.includes(
                                                    exam
                                                ) || false
                                            }
                                            onChange={(e) => {
