...
const AddTest = ({ onClose, onTestAdded }) => {
    ...
    const handleAddSubCategory = async () => {
        ...
        if (!validateInput(newSubCategory)) {
            setError((prev) => ({
                ...prev,
                newSubCategory: 'Only letters, numbers, spaces, and hyphens are allowed',
            }));
            return;
        }
        ...
        try {
            ...
            Swal.fire({
                icon: 'warning',
                title: 'Oops!',
                text: error.response?.data.errMsg || 'Failed to add subcategory. Please try again.',
    ...
    const handleAddSubType = async () => {
        ...
        try {
            ...
            Swal.fire({
                ...
                text: error.response?.data?.errMsg || 'Could not add the type. Please try again.',
                confirmButtonColor: '#d33',
            });
        }
    };
