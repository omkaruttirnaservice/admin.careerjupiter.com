...
const Infrastructure = () => {
        ...
        onSubmit: async (values) => {
            try {
                ...
                if (response.data.success) {
                    ...
                    throw new Error(response.data.errMsg || 'Failed to save infrastructure');
                }
            } catch (error) {
                console.error(
                    'Error saving infrastructure:',
    ...
    const removeInfrastructure = (index) => {
        const newInfrastructure = formik.values.infrastructure.filter((_, i) => i !== index);
        formik.setValues({
                      ...
                      {formik.errors.infrastructure[index].hostelDetails}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="mb-4">
                                ...
                                {formik.touched.infrastructure?.[index]?.canteenAndFoodServices &&
