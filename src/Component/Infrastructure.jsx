...
//     <div key={index} className="p-4 border border-blue-200 rounded-md bg-blue-50 shadow-sm">
//       {/* Campus Area */}
//           {/* <div>
//             <label
//               // htmlFor="campusArea"
...
//   />
//   {formik.touched.numberOfLabs && formik.errors.numberOfLabs && (
//     <p className="text-red-500 text-sm mt-1">{formik.errors.numberOfLabs}</p>
//   )}
// </div>
//           </div>
...
//           "sportsFacilities",
//           formik.values.sportsFacilities.includes("Indoor")
//             ? formik.values.sportsFacilities.filter((item) => item !== "Indoor")
//             : [...formik.values.sportsFacilities, "Indoor"]
//         );
//       }}
//     />
...
//           "sportsFacilities",
//           formik.values.sportsFacilities.includes("Outdoor")
//             ? formik.values.sportsFacilities.filter((item) => item !== "Outdoor")
//             : [...formik.values.sportsFacilities, "Outdoor"]
//         );
//       }}
//     />
...
//   <div className="text-red-500 text-sm mt-1">{formik.errors.sportsFacilities}</div>
// )}
...
//     <option value="false">No</option>
//   </select>
//   {formik.touched.hostelAvailability && formik.errors.hostelAvailability && (
//     <p className="text-red-500 text-sm mt-1">{formik.errors.hostelAvailability}</p>
//   )}
// </div>
...
//     />
//     {formik.touched.hostelDetails && formik.errors.hostelDetails && (
//       <p className="text-red-500 text-sm mt-1">{formik.errors.hostelDetails}</p>
//     )}
//   </div>
// )}
...
//       <option value="false">Not Available</option>
//     </select>
//     {formik.touched.canteenAndFoodServices && formik.errors.canteenAndFoodServices && (
//       <div className="text-red-500 text-sm mt-1">
//         {formik.errors.canteenAndFoodServices}
//       </div>
//     )}
...
//       <option value="false">Not Available</option>
//     </select>
//     {formik.touched.medicalFacilities && formik.errors.medicalFacilities && (
//       <div className="text-red-500 text-sm mt-1">
...
//                 ? formik.values.transportFacility.filter((item) => item !== value)
...
//     ))}
//   </div>
//   {formik.touched.transportFacility && formik.errors.transportFacility && (
//     <div className="text-red-500 text-sm mt-1">{formik.errors.transportFacility}</div>
//   )}
// </div>
//           </div>
//   ))}
