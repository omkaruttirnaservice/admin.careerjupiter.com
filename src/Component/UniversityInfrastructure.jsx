...
function UniversityInfrastructure() {
    ...
    const validationSchema = Yup.object({
        ...
        numberOfLabs: Yup.number().min(1, 'Must have at least 1 lab').required('Required'),
        ...
        <div className="flex justify-center ">
            <div className="relative w-[90%] max-w-[1200px] bg-blue-100 p-6 mt-10 rounded-lg shadow-lg">
                ...
                <h2 className="text-2xl font-semibold text-blue-900 mb-4">
                    {isEditing ? 'Edit University Infrastructure' : 'Add University Infrastructure'}
                </h2>

                <form onSubmit={formik.handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text-blue-700 font-medium">Campus Area:</label>
                        <input
                            type="text"
                            name="campusArea"
                        ...
                        {formik.touched.campusArea && formik.errors.campusArea && (
                            <p className="text-red-500 text-sm mt-1">{formik.errors.campusArea}</p>
                        )}
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-blue-700 font-medium">Classrooms:</label>
                            <input
                                type="number"
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                formik.setFieldValue('medicalFacilities', e.target.value === 'true')
                            }
                            className="w-full p-2 border rounded-lg">
                            <option value="false">No</option>
                            <option value="true">Yes</option>
