...
import { FaChevronUp, FaChevronDown, FaCheck, FaEdit, FaTrash } from 'react-icons/fa';
...
const ManageRoadmapForm = () => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (subTypeDropdownRef.current && !subTypeDropdownRef.current.contains(event.target)) {
                                        ...
                                        <div className="sticky top-0 bg-white p-2 border-b">
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    const filtered = subTypeOptions.filter(
                                                        (option) =>
                                                            option.type
                                                                .toLowerCase()
                                                                .includes(searchTerm)
