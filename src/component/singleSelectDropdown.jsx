  ...
  return (
    <div className="mb-4 w-full">
      ...
      >
        ...
        {/* Inject value not in options */}
        {!options.includes(formik.values[name]) && formik.values[name] && (
          <option value={formik.values[name]} hidden>
            {formik.values[name]}
          </option>
        )}
...
//   return (
//     <div className="mb-4 w-full">
//       <label className="block text-blue-900 font-semibold mb-2 text-lg">{label}</label>
//       <select
//         id={name}
//         name={name}
//         {...formik.getFieldProps(name)}
